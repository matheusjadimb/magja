...
public class ProductAttribute extends BaseMagentoModel<Object[]> {
	...
	public String toString() {
		return "ProductAttribute [applyTo=" + applyTo + ", attributeClass=" + attributeClass + ", backend=" + backend + ", code=" + code + ", comparable="
				+ comparable + ", defaultValue=" + defaultValue + ", filterable=" + filterable + ", frontend=" + frontend + ", group=" + group + ", input="
				+ input + ", label=" + label + ", options=" + options + ", required=" + required + ", scope=" + scope + ", searchable=" + searchable
				+ ", sortBy=" + sortBy + ", source=" + source + ", type=" + type + ", unique=" + unique + ", userDefined=" + userDefined + ", visible="
				+ visible + ", visibleInAdvancedSearch=" + visibleInAdvancedSearch + ", visibleOnFront=" + visibleOnFront + ", configurable=" + configurable
