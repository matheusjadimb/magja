...
public class Category extends BaseMagentoModel {
	 ...
	 * @param name
	 * @param position
	 *            Position of the assigned product in this category.
	 */
	...
	public int hashCode() {
		...
		result = prime * result + ((includeInMenu == null) ? 0 : includeInMenu.hashCode());
		result = prime * result + ((availableSortBy == null) ? 0 : availableSortBy.hashCode());
		result = prime * result + ((children == null) ? 0 : children.hashCode());
		result = prime * result + ((defaultSortBy == null) ? 0 : defaultSortBy.hashCode());
	...
	public String toString() {
		return "Category [active=" + active + ", anchor=" + anchor + ", includeInMenu=" + includeInMenu + ", availableSortBy=" + availableSortBy
				+ ", defaultSortBy=" + defaultSortBy + ", description=" + description + ", level=" + level + ", metaDescription=" + metaDescription
				+ ", metaKeywords=" + metaKeywords + ", metaTitle=" + metaTitle + ", name=" + name + ", parent=" + parent + ", position=" + position + ", id="
