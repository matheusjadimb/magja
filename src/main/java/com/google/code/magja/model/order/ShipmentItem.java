...
public class ShipmentItem extends BaseMagentoModel {
	...
	public ShipmentItem(String sku, String name, Integer orderItemId, Integer productId, Double weight, Double price, Double qty) {
		super();
		this.sku = sku;
		this.name = name;
	...
	public String toString() {
		return "ShipmentItem [name=" + name + ", orderItemId=" + orderItemId + ", price=" + price + ", productId=" + productId + ", qty=" + qty + ", sku="
				+ sku + ", weight=" + weight + ", id=" + id + ", properties=" + properties + "]";
	}
}
