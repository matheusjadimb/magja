...
public interface ProductMediaRemoteService extends GeneralService<ProductMedia> {
	 ...
	 * http://code.google.com/p/magja/downloads/detail
	 * ?name=media.md5.api.xml.diff and
	 * http://code.google.com/p/magja/downloads/
	 * detail?name=media.md5.api.xml.diff
	 * 
	 * @param file
	 * @return MD5 sum
	 * @throws ServiceException
	 ...
	 * @throws ServiceException
	 */
	public abstract void create(ProductMedia productMedia) throws ServiceException;
