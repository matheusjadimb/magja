...
public interface ProductRemoteService extends GeneralService<Product> {
	 ...
	 * @param product
	 */
	public abstract void add(Product product) throws ServiceException, NoSuchAlgorithmException;
	 ...
	 * @param product
	 */
	public abstract void add(Product product, String storeView) throws ServiceException, NoSuchAlgorithmException;
	 ...
	 *            The old product data object. Used to compare which data needs
	 *            to be updated.
	 */
	public abstract void update(Product product, Product existingProduct) throws ServiceException, NoSuchAlgorithmException;
	 ...
	 *            to be updated.
	 */
	public abstract void update(Product product, Product existingProduct, String storeView) throws ServiceException, NoSuchAlgorithmException;
