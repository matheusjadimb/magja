...
public interface ProductLinkRemoteService extends GeneralService<ProductLink> {
	 ...
	 */
	public abstract Set<ProductLink> list(Product product) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public abstract Set<ProductLink> list(LinkType linktype, Product product) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public abstract void assign(Product product, ProductLink link) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public abstract void update(Product product, ProductLink link) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public abstract void remove(Product product, ProductLink link) throws ServiceException;
