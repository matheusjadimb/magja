...
public class ProductMediaRemoteServiceTest {
	...
	public void testSaveProductWithTwoMedias() {
		...
		try {
			...
			byte[] data1 = MagjaFileUtils.getBytesFromFileURL("http://www.rockstore.com.br/store/catalog/co356.jpg");
			...
			byte[] data2 = MagjaFileUtils.getBytesFromFileURL("http://www.rockstore.com.br/store/catalog/co356_foto.jpg");
