...
public class CategoryRemoteServiceTest {
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.category.CategoryRemoteServiceImpl#getByIdClean(java.lang.Integer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.category.CategoryRemoteServiceImpl#getByIdWithChildren(java.lang.Integer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.category.CategoryRemoteServiceImpl#getByIdWithParent(java.lang.Integer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.category.CategoryRemoteServiceImpl#getByIdWithParentAndChildren(java.lang.Integer)}
	 * .
	 */
	@Test
	public void testGetByIdWithParentAndChildren() throws Exception {
		...
		if (category != null) {
			if (category.getParent() != null)
				System.out.println("parent: " + category.getParent().toString());
	...
	public void testCreate() throws Exception {
		...
		/*
		 * categories.add(service.getRequiredCategory(0, "Sub Category 2", new
		 * String "name", "price"}, "name", true, true));
		 * categories.add(service.getRequiredCategory(0, "Under Sub Category 3",
		 * new String[] {"name"}, "name", true, true));
		 */
	...
	public void testLinkCategory() throws Exception {
		...
		// categories.add(service.getRequiredCategory(0, "cat2", new String[]
		// {"name", "price"}, "name", true, true));
