...
public class ProductRemoteServiceTest {
	...
	/**
	 * Just a test for create up to 50 products for performance purposes, maked
	 * as ignore for maven builds
	 * 
	 * @throws Exception
	 */
	@Test
	 ...
	 * exemplify the use of Product Configurable Before run this test, create
	 * some Attribute Set in Magento admin and change the name and id bellow of
	 * that to work. this test use two configurable attributes for instance,
	 * size and color
	 */
	@Test
	public void testSaveConfigurableProduct() throws ServiceException, NoSuchAlgorithmException {
		...
		/*
		 * creates the Configurable Attributes Data, that are the attributes
		 * wich are configurable for this product
		 */
		...
		/*
		 * creates the variations of the attributes, for each configurable
		 * attribute it can add a new product for this variation, remember you
		 * have to creates the Configurable Attributes Data first (above code)
		 */
		...
		// don't forget to add the ConfigurableProductData as a subproduct to
		// the main product
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl #save(com.google.code.magja.model.product.Product)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl#getById(java.lang.Integer)}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl#listAll()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl#listAllNoDep()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl#listAllPlus()}
	 * .
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link com.google.code.magja.service.product.ProductRemoteServiceImpl#listAllProductTypes()}
	 * .
	 */
	@Test
	...
	public static Product generateProductWithoutImage() {
		...
		product.setSku("zibalabel_t13");// (MagjaStringUtils.randomString(3,
										// 10).toUpperCase());
		product.setName("Tas T09");// (MagjaStringUtils.randomString(3, 5) +
									// " Product Test");
	...
	public void updatePrice() throws NoSuchAlgorithmException, ServiceException {
		ImmutableList<ProductUpdatePrice> products = ImmutableList.of(new ProductUpdatePrice("ajah_a", new BigDecimal(1000000), new BigDecimal(2000000)),
